...
#include <cstdlib> // handles exit failure
#include <GL/glew.h> // GLEW library
#include <GLFW/glfw3.h> // GLFW library

using namespace std; // Useing standard namespace

namespace {
	const char* const WINDOW_TITLE = "2-3 Assignment: 2D Triangles"; // Name of Window
	const int WINDOW_WIDTH = 800; // Width of window
	const int WINDOW_HEIGHT = 600; // Height of window

	// Stores GL data for given mesh
	struct GLMesh {
		GLuint vao; // Handle for the ertex array object
...
bool UInitialize(int argc, char* argv[], GLFWwindow** window) {
	...
	glfwWindowHint(GLFW_OPENGL_PROFILE, GLFW_OPENGL_CORE_PROFILE);
		...
		* window = glfwCreateWindow(WINDOW_WIDTH, WINDOW_HEIGHT, WINDOW_TITLE, NULL, NULL);
		...
		// GLEW Initialize for version 1.13 or earlier
...
void UCreateMesh(GLMesh& mesh) {
	...
	GLfloat verts[] =
	{
		...
		// index 1
		-1.0f, 0.0f, 0.0f,     // Center Left
		0.0f, 0.0f, 1.0f, 1.0f, // blue

		// index 2
		-0.5f, 0.0f, 0.0f,      // Center Middle-Left
