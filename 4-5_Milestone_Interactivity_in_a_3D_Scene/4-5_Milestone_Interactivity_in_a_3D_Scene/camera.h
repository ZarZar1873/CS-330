...
/*
* Defines several possible options for camera movement.Used as abstraction to stay away from window -
...
public:
    ...
    * scrollwheel forward (Away from user) is slower movement
    * scroll-wheel backward (toward user) is faster movement
    */
